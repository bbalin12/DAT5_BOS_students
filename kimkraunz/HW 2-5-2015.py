...
# creates model based on K nearest neighbors (optimal k found above to be 11) on
# the training group
...
# test the model again using 10-fold cross-validation
...
# calculates the average accuracy score. 
mean_accuracy = numpy.mean(scores) 
print "The mean accuracy of my K fold cross validation is: %f" % (mean_accuracy * 100)
print "The accuracy of my initial model is: %f" % (accuracy * 100)
...
# calculates the average accuracy score. 
total_errors_mean_accuracy = numpy.mean(scores) 
print "The mean accuracy of my K fold cross validation on my total errors model is: %f" % (total_errors_mean_accuracy * 100)
print "The accuracy of a model that uses total errors instead of error rate is: %f" % (100*total_error_accuracy)
print "The mean accuracy of my K fold cross validation is: %f" % (mean_accuracy * 100)
print "The accuracy of my initial model is: %f" % (accuracy * 100)
...
# calculates the average accuracy score. 
smaller_mean_accuracy = numpy.mean(scores) 
print "The mean accuracy of my K fold cross validation on my simpler model is: %f" % (100*smaller_mean_accuracy)
print "The accuracy of a model that doesn't include average ERA and years played is: %f" % (100*smaller_accuracy)
print "The mean accuracy of my K fold cross validation on my total errors model is: %f" % (total_errors_mean_accuracy * 100)
print "The accuracy of a model that uses total errors instead of error rate is: %f" % (100*total_error_accuracy)
print "The mean accuracy of my K fold cross validation is: %f" % (mean_accuracy * 100)
...
print "The accuracy of the simplest model on those inducted before 2000 is: %f" % (100*smaller_accuracy)
print "The mean accuracy from K fold cross validation on the simplest model on those inducted before 2000 is: %f" % (100*smaller_mean_accuracy)
